...
a persistence unit "ExamenSanchezLuisServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenSanchezLuisServidor\pom.xml":
...
artifact ("ExamenSanchezLuisServidor.war") is already built. You can build
